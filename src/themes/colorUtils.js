...
function createCustomThemeStylesheet(theme) {
    let embeddedStyles = '\n/** Custom theme **/\n:root[theme="custom"] {\n\n';
...
exports.createCustomThemeStylesheet = createCustomThemeStylesheet;
function clearThemeProperties(DOMElement) {
    for (const color of [
...
exports.clearThemeProperties = clearThemeProperties;
