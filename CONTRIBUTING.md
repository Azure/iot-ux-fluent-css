# Contributing to the Azure IoT Fluent CSS library
...
The [issue tracker](https://github.com/Azure/iot-ux-fluent-css/issues) is
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your
   ...
   git clone https://github.com/<your-username>/iot-ux-fluent-css.git
   # Navigate to the newly cloned directory
   cd iot-ux-fluent-css
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/Azure/iot-ux-fluent-css.git
   ```
